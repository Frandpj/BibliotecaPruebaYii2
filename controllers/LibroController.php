...
class LibroController extends Controller
{
        ...
        return array_merge(
            ...
            [
                ...
                'access' => [
                    ...
                    // Acciones que se permiten sin autenticación
     ...
     */
    public function subirFoto(Libro $model)
    {
            ...
            if ($model->load($this->request->post())) {
                ...
                if ($model->validate()) {
                    ...
                    if ($model->archivo) {
                        ...
                        // Si se guardó el archivo
                        if ($model->archivo->saveAs($rutaArchivo)) {
                            // Se guarda la ruta en el modelo
